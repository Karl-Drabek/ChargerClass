...
public class DartlingGunDrawLayer : AnimatedDrawLayer
{
	int framesAtShoot = 0;
	int shotsAtShoot = 0;
	...
	public override void SafeSetStaticDefaults()
	{
		...
		ticsPerFrame = 10;
		scale = 1f;
		textureAsset = ModContent.Request<Texture2D>("ChargerClass/Common/DrawLayers/DartlingGunDrawLayer");
		itemType = ModContent.ItemType<DartlingGun>();
	}
