...
public class BloontoniumBlasterDrawLayer : AnimatedDrawLayer
{
	int framesAtShoot = 0;
	int shotsAtShoot = 0;
	...
	public override void SafeSetStaticDefaults()
	{
		...
		ticsPerFrame = 10;
		scale = 1f;
		textureAsset = ModContent.Request<Texture2D>("ChargerClass/Common/DrawLayers/BloontoniumBlasterDrawLayer");
		itemType = ModContent.ItemType<BloontoniumBlaster>();
	}
