...
namespace ChargerClass.Content.Tiles
{
	public class ElectrudiumOre : ModTile
	{
		public override void SetStaticDefaults() {
			...
			Main.tileShine[Type] = 450; // How often tiny dust appear off this tile. Larger is less frequently
	...
	{
		public static LocalizedText ElectrudiumOrePassMessage { get; private set; }

		public override void SetStaticDefaults() {
			ElectrudiumOrePassMessage = Language.GetOrRegister(Mod.GetLocalizationKey($"WorldGen.{nameof(ElectrudiumOrePassMessage)}"));
		}
		...
		public override void ModifyWorldGenTasks(List<GenPass> tasks, ref double totalWeight) {
			...
			if (ShiniesIndex != -1) {
				...
				tasks.Insert(ShiniesIndex + 1, new ElectrudiumOrePass("Charger Class Ores", 237.4298f));
			}
		}
	}

	public class ElectrudiumOrePass : GenPass
	{
		public ElectrudiumOrePass(string name, float loadWeight) : base(name, loadWeight) {}
		...
		protected override void ApplyPass(GenerationProgress progress, GameConfiguration configuration) {
			...
			progress.Message = ChargerClassOreSystem.ElectrudiumOrePassMessage.Value;
