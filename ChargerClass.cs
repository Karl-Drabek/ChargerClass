	...
	public override void HandlePacket(BinaryReader reader, int whoAmI)
	{
		...
		switch (msgType) {
			case MessageType.StatIncreasePlayerSync:
				...
				ChargeModPlayer modPlayer = Main.player[playernumber]
			...
			case MessageType.DartAssemblyStationSync:
				...
				DartAssemblyStationTileEntity station =
					TileEntity.ByID[id] as DartAssemblyStationTileEntity;
